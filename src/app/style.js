const styles = {
  ...
  bodySm: "font-body text-body-xs sm:text-body-sm ",
  bodyXs: "font-body text-body-xxs sm:text-body-xs ",

  bodyLight: "font-light ",
  bodyBase: "font-normal ",
  bodySemi: "font-semi ",
  bodyBold: "font-bold ",

  navText:
    "font-body font-normal text-dark-primary sm:text-body-lg hover:font-bold ease-in-out duration-300",
